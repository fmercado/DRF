...
class ArticleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Article
        # fields = "__all__" # all the fields on our model
...
#                 "Title & Description must be different from one another"
#             )
#         return data
#
#     def validate_title(self, value):
#         """ Will check the field title for len constrains """
#         if len(value)<3:
#             raise serializers.ValidationError("Title must be at least 3 chr long")
#         return value
